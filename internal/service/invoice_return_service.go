...
Регион: %s 
	...
	return model.InvoiceReturn{}, nil
}
...
func (service *invoiceReturnService) GetMaterialsForEdit(id uint) ([]dto.InvoiceReturnMaterialForEdit, error) {
	return service.invoiceReturnRepo.GetMaterialsForEdit(id)
}
